...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.MyViewHolder> {
    ...
    public ArrayList<NewsData> agriculturenews;
    public String Category;

    public NewsAdapter(Context context, ArrayList<NewsData> agriculturenews, String category) {
        this.context = context;
        this.agriculturenews = agriculturenews;
        Category = category;
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.agriculturenews, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        NewsData models = agriculturenews.get(position);
