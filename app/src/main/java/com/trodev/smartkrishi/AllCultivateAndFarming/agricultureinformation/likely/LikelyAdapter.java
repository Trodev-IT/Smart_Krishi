...
public class LikelyAdapter extends RecyclerView.Adapter<LikelyAdapter.MyViewHolder> {
    public Context context;
    public ArrayList<LikelyData> listagricultureinformation;
    public String Category;

    public LikelyAdapter(Context context, ArrayList<LikelyData> listagricultureinformation, String category) {
    ...
    @NonNull
    @Override
    public LikelyAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        LikelyData models = listagricultureinformation.get(position);
