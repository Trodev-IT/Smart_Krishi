...
public class CowBreedingAdapter extends RecyclerView.Adapter<CowBreedingAdapter.MyViewHolder> {

    public Context context;
    public ArrayList<CowBreedingData> listanimal;
    public String Category;

    public CowBreedingAdapter(Context context, ArrayList<CowBreedingData> listanimal, String category) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        CowBreedingData models = listanimal.get(position);
