...
public class PigeonAdapter extends RecyclerView.Adapter<PigeonAdapter.MyViewHolder> {
    public Context context;
    public ArrayList<PigeonData> listhen;
    public String Category;

    public PigeonAdapter(Context context, ArrayList<PigeonData> listhen, String category) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        PigeonData models = listhen.get(position);
