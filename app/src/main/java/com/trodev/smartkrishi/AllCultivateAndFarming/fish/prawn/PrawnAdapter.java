...
public class PrawnAdapter extends RecyclerView.Adapter<PrawnAdapter.MyViewHolder> {

    public Context context;
    public ArrayList<PrawnData> listfishl;
    public String Category;

    public PrawnAdapter(Context context, ArrayList<PrawnData> listfishl, String category) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        PrawnData models = listfishl.get(position);
