...
public class FishDiseaseAdapter extends RecyclerView.Adapter<FishDiseaseAdapter.MyViewHolder> {

    public Context context;
    public ArrayList<FishDiseaseData> listfishl;
    public String Category;

    public FishDiseaseAdapter(Context context, ArrayList<FishDiseaseData> listfishl, String category) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        FishDiseaseData models = listfishl.get(position);
