...
public class CowAcommodationAdapter extends RecyclerView.Adapter<CowAcommodationAdapter.MyViewHolder> {

    public Context context;
    public ArrayList<CowAcommodationData> listanimal;
    public String Category;

    public CowAcommodationAdapter(Context context, ArrayList<CowAcommodationData> listanimal, String category) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        CowAcommodationData models = listanimal.get(position);
