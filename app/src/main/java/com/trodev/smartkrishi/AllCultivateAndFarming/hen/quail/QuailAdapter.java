...
public class QuailAdapter extends RecyclerView.Adapter<QuailAdapter.MyViewHolder> {
    public Context context;
    public ArrayList<QuailData> listhen;
    public String Category;

    public QuailAdapter(Context context, ArrayList<QuailData> listhen, String category) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        QuailData models = listhen.get(position);
