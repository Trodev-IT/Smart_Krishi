...
public class CowFeedingAdapter extends RecyclerView.Adapter<CowFeedingAdapter.MyViewHolder> {

    public Context context;
    public ArrayList<CowFeedingData> listanimal;
    public String Category;

    public CowFeedingAdapter(Context context, ArrayList<CowFeedingData> listanimal, String category) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        CowFeedingData models = listanimal.get(position);
