...
public class PecockAdapter extends RecyclerView.Adapter<PecockAdapter.MyViewHolder> {
    public Context context;
    public ArrayList<PecockData> listhen;
    public String Category;

    public PecockAdapter(Context context, ArrayList<PecockData> listhen, String category) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        PecockData models = listhen.get(position);
