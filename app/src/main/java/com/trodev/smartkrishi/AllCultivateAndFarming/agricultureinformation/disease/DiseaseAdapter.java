...
public class DiseaseAdapter extends RecyclerView.Adapter<DiseaseAdapter.MyViewHolder> {
    ...
    public ArrayList<DiseaseData> listagricultureinformation;
    public String Category;

    public DiseaseAdapter(Context context, ArrayList<DiseaseData> listagricultureinformation, String category) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        DiseaseData models = listagricultureinformation.get(position);
