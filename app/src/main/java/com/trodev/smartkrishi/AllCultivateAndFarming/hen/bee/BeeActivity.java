...
public class BeeActivity extends AppCompatActivity {
    ...
    private void showData() {
        ...
        dbRef = reference.child("মৌমাছি চাষ");
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()) {
                    ...
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        BeeData data = snapshot.getValue(BeeData.class);
                        listhen.add(data);
                    }
                    recyclerView.setHasFixedSize(true);
                    recyclerView.setLayoutManager(new LinearLayoutManager(BeeActivity.this));
                    adapter = new BeeAdapter(BeeActivity.this, listhen, "মৌমাছি চাষ");
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(BeeActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
