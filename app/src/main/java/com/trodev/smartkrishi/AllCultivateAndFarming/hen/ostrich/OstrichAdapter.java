...
public class OstrichAdapter extends RecyclerView.Adapter<OstrichAdapter.MyViewHolder> {
    public Context context;
    public ArrayList<OstrichData> listhen;
    public String Category;

    public OstrichAdapter(Context context, ArrayList<OstrichData> listhen, String category) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        OstrichData models = listhen.get(position);
