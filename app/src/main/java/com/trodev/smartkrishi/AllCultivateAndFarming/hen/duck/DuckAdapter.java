...
public class DuckAdapter extends RecyclerView.Adapter<DuckAdapter.MyViewHolder> {
    public Context context;
    public ArrayList<DuckData> listhen;
    public String Category;

    public DuckAdapter(Context context, ArrayList<DuckData> listhen, String category) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        DuckData models = listhen.get(position);
