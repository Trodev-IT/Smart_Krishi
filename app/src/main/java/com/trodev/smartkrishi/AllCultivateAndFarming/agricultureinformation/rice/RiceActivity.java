...
public class RiceActivity extends AppCompatActivity {
    ...
    ArrayList<RiceData> listagricultureinformation;
    RiceAdapter adapter;
    ...
    private void showData() {
        ...
        dbRef = reference.child("ধান বিষয়ক তথ্য");
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()) {
                    ...
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        RiceData data = snapshot.getValue(RiceData.class);
                        listagricultureinformation.add(data);
                    }
                    recyclerView.setHasFixedSize(true);
                    recyclerView.setLayoutManager(new LinearLayoutManager(RiceActivity.this));
                    adapter = new RiceAdapter(RiceActivity.this, listagricultureinformation, "ধান বিষয়ক তথ্য");
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(RiceActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
