...
public class CombinedCultivationActivity extends AppCompatActivity {
    ...
    ArrayList<CombinedData> listagricultureinformation;
    CombinedAdapter adapter;
    ...
    private void showData() {
        ...
        dbRef = reference.child("সমন্বিত চাষ");
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()) {
                    ...
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        CombinedData data = snapshot.getValue(CombinedData.class);
                        listagricultureinformation.add(data);
                    }
                    recyclerView.setHasFixedSize(true);
                    recyclerView.setLayoutManager(new LinearLayoutManager(CombinedCultivationActivity.this));
                    adapter = new CombinedAdapter(CombinedCultivationActivity.this, listagricultureinformation, "সমন্বিত চাষ");
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CombinedCultivationActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
