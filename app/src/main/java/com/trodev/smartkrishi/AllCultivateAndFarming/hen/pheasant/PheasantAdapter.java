...
public class PheasantAdapter extends RecyclerView.Adapter<PheasantAdapter.MyViewHolder> {
    public Context context;
    public ArrayList<PheasantData> listhen;
    public String Category;

    public PheasantAdapter(Context context, ArrayList<PheasantData> listhen, String category) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        PheasantData models = listhen.get(position);
