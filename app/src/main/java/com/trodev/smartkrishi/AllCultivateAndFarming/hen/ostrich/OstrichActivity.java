...
public class OstrichActivity extends AppCompatActivity {
    ...
    ArrayList<OstrichData> listhen;
    OstrichAdapter adapter;
    ...
    private void showData() {
        ...
        dbRef = reference.child("বাণিজ্যিকভাবে উটপাখি পালন");
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()) {
                    ...
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                       OstrichData data = snapshot.getValue(OstrichData.class);
                        listhen.add(data);
                    }
                    recyclerView.setHasFixedSize(true);
                    recyclerView.setLayoutManager(new LinearLayoutManager(OstrichActivity.this));
                    adapter = new OstrichAdapter(OstrichActivity.this, listhen, "বাণিজ্যিকভাবে উটপাখি পালন");
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(OstrichActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
