...
public class CombinedAdapter extends RecyclerView.Adapter<CombinedAdapter.MyViewHolder> {
    ...
    public ArrayList<CombinedData> listagricultureinformation;
    public String Category;

    public CombinedAdapter(Context context, ArrayList<CombinedData> listagricultureinformation, String category) {
    ...
    @NonNull
    @Override
    public CombinedAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        CombinedData models = listagricultureinformation.get(position);
