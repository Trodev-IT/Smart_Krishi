...
public class FertilizerAdapter extends RecyclerView.Adapter<FertilizerAdapter.MyViewHolder> {
    public Context context;
    public ArrayList<FertilizerData> listagricultureinformation;
    public String Category;

    public FertilizerAdapter(Context context, ArrayList<FertilizerData> listagricultureinformation, String category) {
    ...
    @NonNull
    @Override
    public FertilizerAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        FertilizerData models = listagricultureinformation.get(position);
