...
public class BeeAdapter extends RecyclerView.Adapter<BeeAdapter.MyViewHolder> {
    public Context context;
    public ArrayList<BeeData> listhen;
    public String Category;

    public BeeAdapter(Context context, ArrayList<BeeData> listhen, String category) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        BeeData models = listhen.get(position);
