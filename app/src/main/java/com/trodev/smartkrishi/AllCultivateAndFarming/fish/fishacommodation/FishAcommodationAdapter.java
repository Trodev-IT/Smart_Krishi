...
public class FishAcommodationAdapter extends RecyclerView.Adapter<FishAcommodationAdapter.MyViewHolder> {

    public Context context;
    public ArrayList<FishAcommodationData> listfishl;
    public String Category;

    public FishAcommodationAdapter(Context context, ArrayList<FishAcommodationData> listfishl, String category) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        FishAcommodationData models = listfishl.get(position);
