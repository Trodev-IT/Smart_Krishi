...
public class FishBreedingAdapter extends RecyclerView.Adapter<FishBreedingAdapter.MyViewHolder> {

    public Context context;
    public ArrayList<FishBreedingData> listfishl;
    public String Category;

    public FishBreedingAdapter(Context context, ArrayList<FishBreedingData> listfishl, String category) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        FishBreedingData models = listfishl.get(position);
