...
public class MedicinesAdapter extends RecyclerView.Adapter<MedicinesAdapter.MyViewHolder> {
    ...
    public ArrayList<MedicinesData> listagricultureinformation;
    public String Category;

    public MedicinesAdapter(Context context, ArrayList<MedicinesData> listagricultureinformation, String category) {
    ...
    @NonNull
    @Override
    public MedicinesAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        MedicinesData models = listagricultureinformation.get(position);
