...
public class CombinedFishAdapter extends RecyclerView.Adapter<CombinedFishAdapter.MyViewHolder> {

    public Context context;
    public ArrayList<CombinedFishData> listfishl;
    public String Category;

    public CombinedFishAdapter(Context context, ArrayList<CombinedFishData> listfishl, String category) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        CombinedFishData models = listfishl.get(position);
