...
public class FlowersAdapter extends RecyclerView.Adapter<FlowersAdapter.MyViewHolder> {
    ...
    public ArrayList<FlowersData> listagricultureinformation;
    public String Category;

    public FlowersAdapter(Context context, ArrayList<FlowersData> listagricultureinformation, String category) {
    ...
    @NonNull
    @Override
    public FlowersAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        FlowersData models = listagricultureinformation.get(position);
