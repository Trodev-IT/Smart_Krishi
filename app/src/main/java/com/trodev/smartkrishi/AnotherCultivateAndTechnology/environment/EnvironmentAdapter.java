...
public class EnvironmentAdapter extends RecyclerView.Adapter<EnvironmentAdapter.MyViewHolder> {
    ...
    public ArrayList<EnvironmentData> listanother;
    public String Category;

    public EnvironmentAdapter(Context context, ArrayList<EnvironmentData> listanother, String category) {
    ...
    @NonNull
    @Override
    public EnvironmentAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        EnvironmentData models = listanother.get(position);
