...
public class AgricultureTechnologyAdapter extends RecyclerView.Adapter<AgricultureTechnologyAdapter.MyViewHolder> {
    public Context context;
    public ArrayList<AgricultureTechnologyData> listanother;
    public String Category;

    public AgricultureTechnologyAdapter(Context context, ArrayList<AgricultureTechnologyData> listanother, String category) {
    ...
    @NonNull
    @Override
    public AgricultureTechnologyAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        AgricultureTechnologyData models = listanother.get(position);
